...
(function () {
  ...
  const playerBarNode = document.querySelector("ytmusic-app-layout>ytmusic-player-bar");
  if (playerBarNode) {
    const likeBtn = playerBarNode.querySelector("ytmusic-like-button-renderer");
    if (likeBtn) likeBtn.insertAdjacentElement("afterend", libraryButton);
  }
  ...
  if (rightControls) {
    ...
    if (shuffleBtn) shuffleBtn.insertAdjacentElement("afterend", sleepTimerButton);
  }
