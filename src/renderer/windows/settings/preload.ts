...
contextBridge.exposeInMainWorld("ytmd", {
  ...
  listExtensions: async () => await ipcRenderer.invoke("ultimate:list-extensions"),
  loadExtension: async (path: string) => await ipcRenderer.invoke("ultimate:load-extension", path),
